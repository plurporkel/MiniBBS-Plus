...
<?php
    ...
    if ($perm->get('defcon')):
?>
    <li><a href="<?php echo DIR; ?>defcon">Manage DEFCON</a> — <span class="unimportant">Do not treat this lightly.</span></li>
<?php
    endif;
    if ($perm->get('manage_messages')):
?>
    <li><a href="<?php echo DIR; ?>message_manager">Manage messages</a> — <span class="unimportant">Edit text from the MiniBBS interface.</span></li>
<?php
    endif;
?>
</ul>
