...
if (isset($_POST['form_sent'])) {
    ...
    $_POST['form']['DEFAULT_MENU'] = trim(str_replace(['  ', ']{'], [' ', '] {'], $_POST['form']['DEFAULT_MENU']));
...
<form action="" method="post">
    ...
    <div class="row">
        ...
        <p class="caption"><strong>Standard options</strong> (click to add):
            ...
            foreach ($template->menu_options as $text => $path) {
                ...
                echo '· <span onclick="document.getElementById(\'DEFAULT_MENU\').value += \' ' . $text . '\';">' . $text . '</span> ';
            }
            ?>
        </p>
    ...
    <div>
        ...
        <p class="caption">For performance reasons, a UID will only track the reply count of the last <em><?php echo number_format(MEMORABLE_TOPICS) ?></em> topics it has visited.</p>
    </div>
    ...
    <div>
        ...
        <p class="caption">The maximum number of UIDs that can be created per hour by a single IP address.</p>
    </div>
    ...
    <div>
        ...
        <p class="caption">Whether to use SHA256 for hashing passwords and tripcodes.</p>
    </div>
    ...
    <div>
        ...
        <p class="caption">A secret string used to salt password hashes.</p>
    </div>
    ...
    <div>
        ...
        <p class="caption">The number of times to stretch the hash for added security.</p>
    </div>
    ...
    <div>
        ...
        <p class="caption">A secret string used to salt tripcode hashes.</p>
    </div>
